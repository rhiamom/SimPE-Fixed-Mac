...
namespace pjse
{
    ...
    partial class LabelledDataOwner
    {
        ...
        // Original WinForms used a 3x3 TableLayoutPanel:
        //   (0,0)=lbLabel   (1,0)=cbDataOwner   (2,0)=valueCell(cbPicker|tbVal)
        //                   (1,1)=lbInstance
        //                   (1,2..2,2)=checkBoxes(ckbDecimal, ckbUseInstancePicker)
        private void InitializeComponent()
        {
            this.lbLabel              = new LabelCompat     { Name = "lbLabel",              Content = "label1",            VerticalAlignment = Avalonia.Layout.VerticalAlignment.Center, Margin = new Avalonia.Thickness(0, 0, 6, 0) };
            ...
            this.lbInstance           = new LabelCompat     { Name = "lbInstance",           Content = "Const value",       VerticalAlignment = Avalonia.Layout.VerticalAlignment.Center };
